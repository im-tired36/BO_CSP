...
print(f"The cost of your rent/mortgage is {rent_mortgage} and {int(rent_mortgage/income*100)}% of your income")
...
print(f"The cost of your is {transportation} and {transportation/income*100}% of your income")
